                ...
                <div class="card-body">
                    ...
                    if ($submit == 'Simpan') {
                        ...
                        if ($submit == "Ubah") {
                            ...
                            if (strlen($nama_file) == 0) {
                                $query = "UPDATE gallery_foto SET JudulFoto='$judul_foto', DeskripsiFoto='$deskripsi_foto', TanggalUnggah='$tanggal', AlbumID='$album_id', NamaFile='$nama_file' WHERE FotoID='$fotoid'";
                            } else {
                                if (move_uploaded_file($tmp_foto, "uploads/" . $nama_file)) {
                        ...
                        if ($deleteFoto) {
                            echo 'Gambar dan semua like & komentar berhasil dihapus';
                            echo '<meta http-equiv="refresh" content="0.8; url=?url=upload">';
                        } else {
                    ...
                    <?php elseif (isset($_GET['edit'])) : ?>
                        <form action="?url=upload&&edit&&fotoid=<?= $val['FotoID'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" value="Ubah" name="submit" class="btn btn-success my-3">
                        </form>
                    <?php endif; ?>
